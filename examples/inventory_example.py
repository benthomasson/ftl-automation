        ...
        "all": {
            "children": {
                "webservers": {
                    ...
                    "vars": {"http_port": 80, "server_role": "frontend"},
                },
                "databases": {
                    "hosts": {
                        "db1": {
...
def main():
    ...
    try:
        ...
        with ftl_automation.automation(
            inventory=inventory_file, modules=["modules"]
        ) as ftl:
        ...
        with ftl_automation.automation(inventory="localhost,") as ftl:
            ...
            result = ftl.run_module("file", path="/tmp/ftl_test", state="touch")
