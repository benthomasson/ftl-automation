...
def main():
    ...
    with ftl_automation.automation(
        ...
        provision_result = linode(name=server_name, image=server_image, ltype=server_type)
...
✅ Server is ready for use!"""
        ...
        complete(message=f"Linode server '{server_name}' deployed and configured successfully")
